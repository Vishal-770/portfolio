...
export default function SplashCursor({
  ...
  useEffect(() => {
    ...
    function initFramebuffers() {
      ...
      if (!rgba) {
        throw new Error("Required framebuffer format 'rgba' is not supported by this device.");
      }
      if (!dye) {
        dye = createDoubleFBO(
          dyeRes.width,
      ...
      if (!rg) {
        throw new Error("Required framebuffer format 'rg' is not supported by this device.");
      }
      if (!velocity) {
      ...
      if (!r) {
        throw new Error("Required framebuffer format 'r' is not supported by this device.");
      }
